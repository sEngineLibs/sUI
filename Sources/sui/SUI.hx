...
class SUI {
	...
	public static inline function compileShaders() {
		SUIShaders.RectDrawer.compile(Shaders.sui_rectangle_vert, Shaders.sui_rectangle_frag);
		...
		SUIShaders.shadowCaster.compile(Shaders.sui_shadows_vert, Shaders.sui_shadows_frag);
